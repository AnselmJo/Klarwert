      ...
      <DialogContent className="max-w-[480px]">
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            <Label htmlFor="filter-period-mode">Zeitraum</Label>
            <Select
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="page">Wie Seiten-Zeitraum</SelectItem>
          ...
          <div className="space-y-1.5">
            <Label htmlFor="filter-sparzweck">Sparzweck</Label>
            <Select
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="all">Alle Sparzwecke</SelectItem>
                {sparzwecke?.map((s) => (
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <Label htmlFor="filter-min">Betrag Min</Label>
              <Input
                id="filter-min"
                inputMode="decimal"
            ...
            <div className="space-y-1.5">
              <Label htmlFor="filter-max">Betrag Max</Label>
              <Input
                id="filter-max"
                inputMode="decimal"
        ...
        <DialogFooter>
          <Button variant="ghost" onClick={() => setState(EMPTY_DETAIL_FILTER)}>
            Zurücksetzen
          </Button>
